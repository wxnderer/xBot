...
text_content = "Hello  ̶T̶w̶i̶t̶t̶e̶r̶ X ! This is a useless tweet with a useless image ! 😊"
...
client.create_tweet(text=text_content, media_ids=[media_id], user_auth=True)